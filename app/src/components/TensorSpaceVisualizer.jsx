...
const TensorSpaceVisualizer = () => {
  ...
  return (
    <div className="visualizer-container">
      <div id="container" className={`${leftSidebarOpen ? "left-open" : ""} ${sidebarOpen ? "right-open" : ""}`} />
      <button
      ...
      <EnhancedImagePanel isOpen={leftSidebarOpen} onSelectImage={handleImageSelect} gradcamImage={gradcamImage} />
      <button
      ...
      <NetworkAnimation
        ...
        getLayerExplanation={(layerType) => "Explanation for " + layerType} // Simplified; use original function if needed
